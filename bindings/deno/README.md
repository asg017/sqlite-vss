...
[![Doc](https://doc.deno.land/badge.svg)](https://doc.deno.land/https/deno.land/x/sqlite-vss@0.1.1-alpha.8/mod.ts)
...
import * as sqlite_vss from "https://deno.land/x/sqlite_vss@v0.1.1-alpha.8/mod.ts";
